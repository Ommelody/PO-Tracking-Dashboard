...
3. ไปแท็บ **Rules** วางเนื้อหาจากไฟล์ `firestore.rules` แล้วกด **Publish**
...
## การใช้งานประจำวัน
1. ส่งออกไฟล์ **Purchase Order** และ **Goods Receipt PO** จาก SAP เป็น `.xlsx`
2. เปิด Dashboard → ปุ่ม **อัปโหลดข้อมูล PO / GR** (มุมขวาบน)
3. เลือกทั้งสองไฟล์ → ใส่หมายเหตุรอบข้อมูล (ถ้าต้องการ) → **ประมวลผลข้อมูล**
