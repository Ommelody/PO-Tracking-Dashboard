...
(ไฟล์ A/P Invoice ใช้ `Base Document Type` + `Base Document Reference` เพื่อโยงกลับไปยังใบรับของ/ใบสั่งซื้อ)

---

## ฟีเจอร์การติดตามและรายงาน
- **กล่อง "รายการที่ต้องติดตาม"** — คลิกดูรายการเอกสาร: *รับของแล้วรอตั้งหนี้*, *ตั้งหนี้แล้วแต่ใบตั้งหนี้ยังไม่ปิด*, และ *PO เกินกำหนดส่ง* (ทุกรายการคลิกเปิดใบสั่งซื้อต้นทางได้)
- **เกินกำหนดส่ง** — ระบบคำนวณจำนวนวันที่เกินจากวันกำหนดส่งเทียบกับวันที่ปัจจุบัน และแสดง "เกิน N วัน" ในตาราง/การ์ด/รายละเอียด (อัปเดตอัตโนมัติตามวันจริง)
- **พิมพ์รายงาน / บันทึก PDF** — ปุ่ม *พิมพ์รายงาน* ในตาราง สร้างรายงานสรุป + ตารางตามตัวกรองปัจจุบัน (รองรับ Ctrl/Cmd+P หรือบันทึกเป็น PDF · จัดหน้า A4 แนวนอนอัตโนมัติ)
- **Export Excel (.xlsx)** — ปุ่ม *Excel* ในตาราง (และในหน้าพิมพ์) ดาวน์โหลดรายการตามตัวกรอง/แท็บปัจจุบันเป็นไฟล์ Excel จริง เปิดได้ทันทีทั้งภาษาไทยและตัวเลข
- **รองรับมือถือ/แท็บเล็ต/เดสก์ท็อป** — ปรับเลย์เอาต์อัตโนมัติ (ตารางเปลี่ยนเป็นการ์ดบนจอเล็ก)
